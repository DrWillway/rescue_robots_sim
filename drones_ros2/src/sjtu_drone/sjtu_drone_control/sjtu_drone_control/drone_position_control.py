...
class DronePositionControl(DroneObject):
    def __init__(self):
        ...
        self.move_drone_to_pose(1.0, 3.0, 3.0)  # Example pose coordinates
        sleep(4)
        self.move_drone_to_pose(3.0, 3.0, 3.0)  # Example pose coordinates
        sleep(5)
        self.move_drone_to_pose(5.0, 3.0, 3.0)  # Example pose coordinates
