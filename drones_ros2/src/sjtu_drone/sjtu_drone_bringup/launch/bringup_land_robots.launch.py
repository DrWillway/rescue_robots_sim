...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(neo_simulation2_path, 'launch', 'multi_robot_simulation.launch.py')
            )
        ),

        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(neo_simulation2_path, 'launch', 'multi_robot_navigation_simple.launch.py')
            )
        ),
